							...
							<li class="nav-item"><a class="nav-link active"
								data-toggle="tab" href="#tabs-1" role="tab">
									<div class="product__thumb__pic set-bg"
										data-setbg="${Product.getImage() }"></div>
							</a></li>
					...
					<div class="col-lg-8">
						<div class="product__details__text">
							<form action="/cart/add/${Product.id }">
								...
								<h3>
									$${Product.getPrice() }<span>70.00</span>
								</h3>
								<p>Coat with quilted lining and an adjustable hood.
									Featuring long sleeves with adjustable cuff tabs, adjustable
									asymmetric hem with elastic side tabs and a front zip fastening
									with placket.</p>
								<div class="product__details__option">
									<div class="product__details__option__size">
										<span>Size:</span>
										<c:forEach items="${listSize }" var="listsize">
											<label for="${listsize.size.name }">${listsize.size.name }
												<input type="radio" id="${listsize.size.name }" value="${listsize.size.name }"
												name="inputSize"> <span style="color: red">${errorSize }</span>
											</label>
										</c:forEach>
									</div>
									<div class="product__details__option__color">
										...
										<c:forEach items="${listColor }" var="listcolor">
											<label class="inputcolor"
												style="background: ${listcolor.color.name}"> <input
												type="radio" id="${listcolor.color.name }" name="inputColor"
												value="${listcolor.color.name }"> <span
												style="color: red">${errorColor }</span>
											</label>
										</c:forEach>
									</div>
								</div>
								<div class="product__details__cart__option">
									<div class="quantity">
										<div class="pro-qty">
											<input type="text" value="1" name="inputQuantity">
										</div>
									</div>
