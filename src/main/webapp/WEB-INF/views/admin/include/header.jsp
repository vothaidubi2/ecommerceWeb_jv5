	...
	<nav class="navbar-mobile">
		<div class="container-fluid">
			<ul class="navbar-mobile__list list-unstyled">
				...
				<li><a class="js-arrow" href="#"> <i class="fas fa-table"></i>Table
				</a>
					<ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
						<li><a href="/admin/accountmanage">Account</a></li>
						<li><a href="/admin/productmanage">Product</a></li>
						<li><a href="/admin/categorymanage">Category</a></li>
	...
	<div class="menu-sidebar__content js-scrollbar1">
		<nav class="navbar-sidebar">
			<ul class="list-unstyled navbar__list">
				...
				<!-- 				<li><a href="table.html"> <i class="fas fa-table"></i>Tables -->
				<!-- 				</a></li> -->
				<li><a class="js-arrow" href="#"> <i class="far fa-check-square"></i>Forms
				</a>
					<ul class="list-unstyled navbar__sub-list js-sub-list">
						<li><a href="/admin/addaccount">Add Account</a></li>
